// /src/repository/TipoDemandaRepository.js
...
class TipoDemandaRepository {
    ...
    async buscarPorID(id, includeTokens = false) {
        let query = this.modelTipoDemanda.findOne({
    ...
    async atualizar(id, parsedData) {
        const TipoDemanda = await this.modelTipoDemanda.findByIdAndUpdate(id, parsedData, {
            new: true
        });
